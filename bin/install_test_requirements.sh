...
pip install -e git+https://github.com/opendata-swiss/ckanext-subscribe.git@upgrade_to_py3_ckan2_11#egg=ckanext-subscribe
pip install -r https://raw.githubusercontent.com/opendata-swiss/ckanext-subscribe/upgrade_to_py3_ckan2_11/requirements.txt

...
paster --plugin=ckan config-tool "$WORKDIR"/test.ini "ckan.plugins = ogdch ogdch_pkg ogdch_res ogdch_group ogdch_org ogdch_showcase ogdch_subscribe ogdch_middleware scheming_datasets scheming_groups scheming_organizations fluent hierarchy_display harvester_dashboard"

...
class TestHelpers(unittest.TestCase):
    ...
    def test_get_sorted_orgs_by_translated_title_fr(self, mock_get_lang):
        ...
        self.assertEqual(
            0, self.find_position_of_org(result_orgs, "AAAAA (FR)")
        )  # noqa
        self.assertEqual(
            2, self.find_position_of_org(result_orgs, "YYYYY (FR)")
        )  # noqa
    ...
    def test_get_sorted_orgs_by_translated_title_it(self, mock_get_lang):
        ...
        self.assertEqual(
            2, self.find_position_of_org(result_orgs, "ZZZZZ (IT)")
        )  # noqa
        self.assertEqual(
            0, self.find_position_of_org(result_orgs, "AAAAA (IT)")
        )  # noqa
    ...
    def test_get_sorted_orgs_by_translated_title_de(self, mock_get_lang):
        ...
        self.assertEqual(
            0, self.find_position_of_org(result_orgs, "bbbbb (DE)")
        )  # noqa
        self.assertEqual(
            2, self.find_position_of_org(result_orgs, "ZZZZZ (DE)")
        )  # noqa
    ...
    def test_get_sorted_orgs_by_translated_title_en(self, mock_get_lang):
        ...
        self.assertEqual(
            0, self.find_position_of_org(result_orgs, "ààààà (EN)")
        )  # noqa
        self.assertEqual(
            1, self.find_position_of_org(result_orgs, "ÉÉÉÉÉ (EN)")
        )  # noqa
        self.assertEqual(
            2, self.find_position_of_org(result_orgs, "üüüüü (EN)")
        )  # noqa

...
class TestHelpers(object):
    ...
    @pytest.mark.parametrize("dataset, expected_terms", test_data)
    def test_dataset_terms_of_use_are_correct(self, dataset, expected_terms):
        assert ogdch_term_utils.get_dataset_terms_of_use(dataset) == expected_terms
